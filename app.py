...
import os
from Senti import (extract_video_id, analyze_sentiment, plot_sentiment, 
                   generate_word_cloud, generate_summary)
from YoutubeCommentScrapper import (save_video_comments_to_csv, get_channel_info, 
...
st.set_page_config(page_title='Reaction Analysis', page_icon='LOGO.png', initial_sidebar_state='auto')
st.sidebar.title("People Reaction Analyzer")
...
hide_st_style = """
            ...
            .css-1v3fvcr {
        color: red;  /* Red color for sidebar title */
    }
            </style>
            """
